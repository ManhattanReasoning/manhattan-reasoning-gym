"""Reference client for verilog_hello: write a pattern, read it back.

Identical protocol test to hello_wishbone/client.py -- the Wishbone TCP
bridge doesn't care whether the flashed design came from Amaranth or plain
Verilog. If this passes, the network path, bridge firmware, bus wiring, and
your design region all work.
